...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Hamster-themed vibrant colors
        hamster: {
          50: '#fef7ed',
          100: '#feecc7',
          200: '#fdd68a',
          300: '#fcb847',
          400: '#fb9d2a',  // Main hamster orange
          500: '#f59e0b',
          600: '#d97706',
          700: '#b45309',
          800: '#92400e',
      ...
      backgroundImage: {
        ...
        'gradient-hamster': 'linear-gradient(135deg, #fb9d2a 0%, #f59e0b 50%, #d97706 100%)',
      },
      backdropBlur: {
        'xs': '2px',
      },
      boxShadow: {
        ...
        'colored-lg': '0 20px 40px rgba(0, 0, 0, 0.15)',
      }
    },
  },
  plugins: [],
